# -*- coding: utf-8 -*-
"""
Created on Fri Nov 12 21:28:40 2021
...
book = xlrd.open_workbook('河流水环境因素.xlsx')
...
book = xlrd.open_workbook('all_env_bac_edited_zero.xlsx')
print('sheet页名称:',book.sheet_names())
sheet = book.sheet_by_index(0)
rows = sheet.nrows
cols = sheet.ncols
...
book = xlrd.open_workbook('all_used_final.xls')
print('sheet页名称:',book.sheet_names())
sheet = book.sheet_by_index(0)
rows = sheet.nrows
cols = sheet.ncols
...
workbook.save('map_data_results/all_results_stage_1_all_years.xls')  
